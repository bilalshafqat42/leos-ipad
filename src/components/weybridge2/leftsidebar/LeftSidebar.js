  ...
  return (
    <>
      <div className="left-navigation-menu">
        ...
        <div className="mini-navigation-bar-left">
          <Link
            to={"/projects/weybridge-gardens-2/exterior"}
            className="d-flex flex-direction-row text-center align-items-center"
          >
            <FontAwesomeIcon
              icon={faBuilding}
        ...
        <div className="mini-navigation-bar-left">
          <Link
            to={"/projects/weybridge-gardens-2/interior"}
            className="d-flex flex-direction-row text-center align-items-center"
          >
            <FontAwesomeIcon
              icon={faCouch}
        ...
        <div className="mini-navigation-bar-left">
          <Link
            to={"/projects/weybridge-gardens-2/amenities"}
            className="d-flex flex-direction-row text-center align-items-center"
          >
            <FontAwesomeIcon
              icon={faHeart}
        ...
        {/* <div className="mini-navigation-bar-left">
          <Link
            to={"/projects/weybridge-gardens-2/walkthrough"}
            className="d-flex flex-direction-row text-center align-items-center"
          >
            <FontAwesomeIcon
              icon={faHeart}
        ...
        <div className="mini-navigation-bar-left">
          <Link
            to={"/projects/weybridge-gardens-2/animation"}
            className="d-flex flex-direction-row text-center align-items-center"
          >
            <FontAwesomeIcon
              icon={faVideo}
