        ...
        <div className="row">
          <div className="col">
            <div className="main-mini-heading-section">
              <Link to="/">
                <h1 className="mt-4 mb-2 page-heading-title">Studio Type E </h1>
              </Link>
              <Link to="/">
                <img
                  src={Logo}
          ...
          <div className="col">
            <div className="containings">
              <div id="slide" className="no-thumbs floor-plans-banners">
                <div className="items wheybridge-item wheybridge-unit-plans-slide-elevens">
...
export default UnitPlansWhey2g11;
