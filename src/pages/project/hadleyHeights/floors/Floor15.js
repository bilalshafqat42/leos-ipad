    ...
    <section className="">
      ...
      <div className="row">
        ...
        <div className="main-mini-heading-sections">
            <h1 className="mt-2 page-heading-title">
              <Link to="/">HADLEY HEIGHTS 15TH FLOOR</Link>
            </h1>
            <Link to="/">
              <img
                src={Logo}
              ...
              <div id="slide">
                <div className="items exterior-one-slide-floor-fifteen">
                  <div className="content">
                    <div className="name">15th Floor </div>
                    <div className="des">
                      {/* descriptim ipsum sedts at dummy text written here. */}
                    </div>
                  </div>
                </div>
                <div className="items exterior-one-slide-floor-fifteen">
                  <div className="content">
                    <div className="name">15th Floor </div>
                    <div className="des">
                      {/* description lorem ipsum st dummy text written here. */}
                    </div>
                  </div>
                </div>
      ...
      <div className="left-navigation-menu units-section-sidebars">
        <div className="row gx-2 m-1">
          {firstFloors.slice(130, 140).map((firstFloor, index) => (
            <div className="col-6">
              <Link
