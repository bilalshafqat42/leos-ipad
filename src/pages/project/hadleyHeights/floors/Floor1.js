    ...
    <section className="">
        ...
        <div className="row">
          ...
          <div className="main-mini-heading-sections">
            <h1 className="mt-2 page-heading-title">
              <Link to="/">HADLEY HEIGHTS 1ST FLOOR</Link>
            </h1>
            <Link to="/">
              <img
                src={Logo}
        ...
        <div className="row">
          <div className="col">
            <div className="containings">
              <div id="slide">
                <div className="items exterior-one-slide-floor-one">
                  <div className="content">
                    <div className="name">1st Floor</div>
      ...
      <div className="left-navigation-menu units-section-sidebars">
        <div className="row gx-2 m-1">
          {firstFloors.slice(0, 6).map((firstFloor, index) => (
            <div className="col-6">
              <Link
