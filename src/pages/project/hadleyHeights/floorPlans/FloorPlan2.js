        ...
        <div className="row">
          ...
          <div className="main-mini-heading-sections">
            <h1 className="mt-2 page-heading-title">
              <Link to="/">HADLEY HEIGHTS 1 BEDROOM APARTMENT</Link>
            </h1>
            <Link to="/">
              <img
                src={Logo}
          ...
          <div className="col">
            <div className="containings">
              <div id="slide" className="no-thumbs floor-plans-banners">
                <div className="items floor-plans  exterior-one-slide-one-unit-3d-2 floorplans-thumb">
                  <div className="content">
                    <div className="name">1 BEDROOM APARTMENT</div>
                    <div className="des">
                      All one bedroom apartments are spacious and feature a
                      fully-fitted kitchen with a breakfast bar and an open-plan
                      living / dining area which connects to a lovely sunny
                      terrace. The bedroom offers an ensuite bathroom and the
                      apartment also features a separate stand-alone guest WC.
                    </div>
                  </div>
                </div>
                <div className="items floor-plans exterior-one-slide-one-unit-3d-2 floorplans-thumb">
