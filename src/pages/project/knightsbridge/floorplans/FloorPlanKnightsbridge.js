          ...
          <div className="col">
            <div className="containings">
              <div id="slide" className="no-thumbs floor-plans-banners">
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-oness"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-ones"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-oness"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-ones"></div>
...
export default FloorPlanKnightsbridge;
