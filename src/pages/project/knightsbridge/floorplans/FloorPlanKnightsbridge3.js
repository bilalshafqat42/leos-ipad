          ...
          <div className="col">
            <div className="containings">
              <div id="slide" className="no-thumbs floor-plans-banners">
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-threess"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-threes"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-threess"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-threes"></div>
...
export default FloorPlanKnightsbridge3;
