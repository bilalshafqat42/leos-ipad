            ...
            <div className="main-mini-heading-section">
              <Link to="/">
                <h1 className="mt-4 mb-2 page-heading-title">
                  4 BEDROOM TOWNHOUSE RIGHT CORNER
                </h1>
              </Link>
              <Link to="/">
                <img
          ...
          <div className="col">
            <div className="containings">
              <div id="slide" className="no-thumbs floor-plans-banners">
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-fourss"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-fours"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-fourss"></div>
                <div className="items wheybridge-item knightsbridge-unit-plans-slide-fours"></div>
...
export default FloorPlanKnightsbridge4;
