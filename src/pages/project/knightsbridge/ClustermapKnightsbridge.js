        ...
        <div className="row">
          <div className="col">
            <div className="containing">
              <div id="slide">
                <div className="items knightsbridge-cluster-map-one-slide"></div>
              </div>
            </div>
          </div>
        </div>
...
export default ClustermapKnightsbridge;
